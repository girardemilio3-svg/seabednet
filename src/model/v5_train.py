...
SEED = int(os.environ.get("V5_SEED", "0")); torch.manual_seed(SEED)
...
_workers = [_ctx.Process(target=_produce_proc, args=(1000+i+SEED*100,), daemon=True)
...
if not sigs: print('held-out eval: no cells sampled; skipped'); raise SystemExit(0)
